        ...
        <b-nav-form>
          ...
          <!--<li class="">-->
            <!--<form target="_blank" action="/search" accept-charset="UTF-8" method="get" ><input name="utf8" type="hidden" value="&#x2713;" />-->
              <!--<input type="text" name="q" id="q" value="" autocomplete="off" placeholder="搜索" class="search" />-->
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right>
          ...
          <template slot="button-content">
            <b-img v-if="token!=null"  rounded="circle" width="35" height="35" src="../../static/img/me.jpg"/>
          </template>
