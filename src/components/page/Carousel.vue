<template>
  <div class="one" style="height: 270px;width: 630px ;" >
    <b-carousel id="carousel1"
      ...
      <b-carousel-slide class="two" v-for="image in imageList" :key="image.id"
                        :img-src="image.url" >
      </b-carousel-slide>
    </b-carousel>
    ...
    data() {
      return {
        ...
        imageList: [
          ...
          {
            "id":6,
            "url":"https://upload.jianshu.io/admin_banners/web_images/4486/41d9173c44ce6eded75da5f82da659973ddaad41.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/1250/h/540"
          }
        ]
      }
    },
